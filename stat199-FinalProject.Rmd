...
This data set entitled trumpTweets includes 53,697 observations. Each individual observation is one of President Donald Trump’s tweets. The original dataset contains 7 variables: source, text, created_at, retweet_count, favorite_count, is_retweeted, id_str. The descriptions of each of the original variables is given below. 
